...
public class Rec1florinefm : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    public GameObject zoomFlorineCamera1fm;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!isSwiping)
        {
            ...
            if (pressDuration <= swipeThreshold)
            {
                ...
                zoomFlorineCamera1fm.SetActive(true);
                animator.SetTrigger("Zoom florine recording1fm");
