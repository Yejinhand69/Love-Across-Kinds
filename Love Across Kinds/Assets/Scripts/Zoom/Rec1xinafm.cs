...
public class Rec1xinafm : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    public GameObject zoomXinaCamera1fm;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!isSwiping)
        {
            ...
            if (pressDuration <= swipeThreshold)
            {
                ...
                zoomXinaCamera1fm.SetActive(true);
                animator.SetTrigger("Zoom xina recording1fm");
