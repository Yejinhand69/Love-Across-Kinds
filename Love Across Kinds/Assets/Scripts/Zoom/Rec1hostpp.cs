...
public class Rec1hostpp : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    public GameObject zoomHostCamera1pp;
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!isSwiping)
        {
            ...
            if (pressDuration <= swipeThreshold)
            {
                ...
                zoomHostCamera1pp.SetActive(true);
                animator.SetTrigger("Zoom host recording1pp");
