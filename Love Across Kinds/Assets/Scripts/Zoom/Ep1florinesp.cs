...
public class Ep1florinesp : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        if (!isSwiping)
        {
            ...
            if (pressDuration <= swipeThreshold)
            {
                ...
                zoomFlorineCamera1sp.SetActive(true);
                animator.SetTrigger("Zoom florine lobby1sp");
